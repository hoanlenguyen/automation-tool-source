        ...
        <div class="modal-card">
            ...
            <section class="modal-card-body">
              ...
              <b-field label="Currency Code">
                <b-input
                  type="Text"
                  v-model.trim="model.currencyCode"
                  placeholder="Currency code....">
                </b-input>
              </b-field>
              <b-field label="Currency Symbol">
                <b-input
                  type="Text"
                  v-model.trim="model.currencySymbol"
...
<script>
import { getDetail, getList, createOrUpdate, deleteData  } from "@/api/currency";
export default {
  name:"bank",
  components: { },
  created() {
