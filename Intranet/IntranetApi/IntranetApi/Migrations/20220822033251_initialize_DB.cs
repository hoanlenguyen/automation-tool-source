    ...
    public partial class initialize_DB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdNumber = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BackendUser = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    BackendPass = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Salary = table.Column<int>(type: "int", nullable: false),
                    Note = table.Column<string>(type: "varchar(150)", maxLength: 150, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IntranetPassword = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandEmployees", x => new { x.BrandId, x.EmployeeId });
                    table.ForeignKey(
                        name: "FK_BrandEmployees_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BrandEmployees_Users_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StaffRecordDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StaffRecordDocuments_StaffRecords_StaffRecordId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrandEmployees_EmployeeId",
                table: "BrandEmployees",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffRecordDocuments_StaffRecordId",
                table: "StaffRecordDocuments",
